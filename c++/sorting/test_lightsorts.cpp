...
{
  std::cout << std::endl;
  std::cout << "Testing light hybrid sort..." << std::endl;
  ...
  LightSorts::lightHybridSort(sequence);
  ...
  std::cout << std::endl;
  std::cout << "Testing light merge sort..." << std::endl;

	
  // Generate random input sequence with 20 elements and
  ...
  // Run sorting algorithm.	
  LightSorts::lightMergeSort(sequence);
