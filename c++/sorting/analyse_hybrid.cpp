...
int main( int argc, char *argv[] )
{
	...
	if(datfile)
	{
		...
		std::cout << std::endl;
		std::cout << "Analysing hybrid sort..." << std::endl;
		...
		resfile.open( "timings_hybrid.txt" );
		resfile << "# hybrid sort running time\n"; 
		...
		std::cout << std::endl;
		std::cout << "Done. Results saved in timings_hybrid.txt." << std::endl;
		std::cout << std::endl;
	}
	else
	{
