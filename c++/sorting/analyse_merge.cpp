...
int main( int argc, char *argv[] )
{
	...
	if(datfile)
	{
		...
		std::cout << std::endl;
		std::cout << "Analysing merge sort..." << std::endl;
		...
		resfile.open( "timings_merge.txt" );
		resfile << "# merge sort running time\n"; 
		...
		std::cout << std::endl;
		std::cout << "Done. Results saved in timings_merge.txt." << std::endl;
		std::cout << std::endl;
	}
	else
	{
